export const tourData = {
  ...
  statueOfEquity: {
    ...
    schema: {
      "@context": "https://schema.org",
      "@type": "TouristTrip",
      "name": "Statue of Equity Half-Day Cab Tour",
      "description": "Half-day cab package from Hyderabad to the 216-foot Statue of Equity in Muchintal, including waiting time for the evening laser show.",
      "provider": {
        "@type": "TravelAgency",
        "name": "Radha Travels"
      }
  ...
  ramoji: {
    ...
    schema: {
      "@context": "https://schema.org",
      "@type": "TouristTrip",
      "name": "Ramoji Film City Cab Package",
      "description": "Dedicated full-day cab package to Ramoji Film City from Hyderabad, offering spacious vehicles, on-time pickups, and safe late-evening returns.",
      "provider": {
        "@type": "TravelAgency",
        "name": "Radha Travels"
      }
  ...
  yadagirigutta: {
    ...
    schema: {
      ...
      "description": "Comfortable outstation cab and wait-and-return service from Hyderabad to Yadagirigutta Sri Lakshmi Narasimha Swamy Temple.",
      "offers": {
        "@type": "AggregateOffer",
        "priceCurrency": "INR",
        "lowPrice": "2500", // Update with your actual starting price
        "highPrice": "8000", // Update with your Tempo Traveller price
        "offerCount": "4"
      }
    }
  },
  ...
  tirupati: {
    ...
    nearbyAttractions: [
      ...
      { name: 'Kapila Theertham', desc: 'A beautiful Shiva temple located at the base of a waterfall.', img: '/images/tirupati/kapila.jpg' },

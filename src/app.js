...
app.get('/tours/:destination', (req, res) => {
  ...
  const tourData = {
    srisailam: {
      ...
      galleryImage1: '/images/srisailam-main.jpg',
      galleryImage2: '/images/srisailam-2.jpg',
      galleryImage3: '/images/srisailam-3.jpg',
      
      nearbyAttractions: [
        { name: 'Pathala Ganga', desc: 'Take a ropeway down to the sacred Krishna river for a holy dip.', img: '/images/pathala-ganga.jpg' },
        { name: 'Srisailam Dam', desc: 'One of the largest working dams in India with breathtaking views.', img: '/images/srisailam-dam.jpg' },
        { name: 'Sakshi Ganapati', desc: 'The deity who keeps a record of all visiting pilgrims.', img: '/images/sakshi-ganapati.jpg' },
        { name: 'Akkamahadevi Caves', desc: 'Ancient naturally formed caves reachable by boat.', img: '/images/akkamahadevi.jpg' }
      ],
    ...
    tirupati: {
      ...
      galleryImage1: '/images/tirupati-main.jpg',
      galleryImage2: '/images/tirupati-2.jpg',
      galleryImage3: '/images/tirupati-3.jpg',
      
      nearbyAttractions: [
        { name: 'Sri Kalahasti', desc: 'The Vayu (Wind) Linga, famous for Rahu-Ketu poojas.', img: '/images/kalahasti.jpg' },
        { name: 'Padmavathi Temple', desc: 'The temple of Goddess Padmavathi in Tiruchanur.', img: '/images/padmavathi.jpg' },
        { name: 'Kapila Theertham', desc: 'A beautiful Shiva temple located at the base of a waterfall.', img: '/images/kapila.jpg' },
        { name: 'Silathoranam', desc: 'A rare natural stone arch located in the Tirumala hills.', img: '/images/silathoranam.jpg' }
      ],
